...
const SEED_PRODUCTS = [
  { id: 1, name: 'Velvet Satin Lip', brand: 'Luna', price: 24, badge: 'Bestseller', emoji: '💄', category: 'makeup', tone: 340, description: 'A soft matte finish with lasting comfort.', stock: 12, soldOut: false, images: [], modelImage: '', reviews: [] },
  ...
  { id: 3, name: 'Lash Lift Mascara', brand: 'Nova', price: 22, badge: 'Top Rated', emoji: '👁️', category: 'makeup', tone: 265, description: 'Builds length and drama without clumping.', stock: 15, soldOut: false, images: [], modelImage: '', reviews: [] },
  { id: 4, name: 'Dawn Blush', brand: 'Luna', price: 28, badge: 'Trending', emoji: '🌸', category: 'makeup', tone: 350, description: 'A rosy flush for a healthy glow.', stock: 10, soldOut: false, images: [], modelImage: '', reviews: [] },
